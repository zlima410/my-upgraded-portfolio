<script>
  ...
  let steps = [
    ...
    {name: 'Processor Simulator', icon: 'fa-solid fa-microchip'},
    {name: 'Cache Simulator', icon: 'fa-solid fa-memory'},
  ]
</script>
  ...
  <section id="introPage" class="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 sm:py-14">
    <div class="flex flex-col lg:justify-center text-center lg:text-left gap-6 md:gap-8 lg:gap-10">
      ...
      <p class="text-base sm:text-lg md:text-xl">
        My <span class="text-[#F9013F]">favorite tech</span> includes C++, Python, Java, JavaScript 
        (SvelteKit, React, Node.js), TailwindCSS, and Git
      </p>
      <a
